...
The foundation now includes the C++20 `techpulse validate` command, a Hacker News adapter with fixture tests, normalized `RadarItem` records, exact provenance-preserving deduplication, explainable rule scoring, an example configuration, and cross-platform CI.
